        ...
        try {
            ...
            for ($batchIndex = 0; $batchIndex < $batchCount; $batchIndex++) {
                ...
                $prompt = implode("\n", [
                    ...
                    "「このレースで結果を残しそうな馬」を紹介することが目的です。",
                    "人気馬（低オッズ）だけを並べることは、このシステムの目的を果たしていません。",
                    "オッズ推移・単複比・変動幅などから、幅広い目線で有力馬を見つける基準を書いてください。",
                    "特に、オッズが高くても単勝・複勝がどちらも継続して下がり続けている馬は、積極的に評価してください。",
                    "反対に、一時的にオッズが急落しただけで、その後すぐ戻るような動きは信頼度が低いと判断してください。",
                    "また、来そうな馬でもオッズが低すぎて旨味がない場合は、紹介する優先度を下げてください。",
                    "「来そうかどうか」と「そのオッズに見合う旨味があるか」は別の話として、両方を判断材料にしてください。",
                    "",
                    "【入力の説明】",
