...
";
            ...
            foreach ($targetRaces as $race) {
                ...
                $msgs = [
                    ...
                    "",
                    "【このタスクの目的（最重要）】",
                    "目的は「当てること」ではなく「回収率を上げること」です。",
                    "1〜3番人気ばかり選んで当てても、オッズが低いため回収率は上がりません。",
                    "「来そうかどうか（信頼度）」と「そのオッズで買う価値があるか（妙味）」を両方考えることが重要です。",
                    "この分析は、今後のAI競馬予測の回収率向上に向けた、馬の選出プロセスの改善に活用されます。",
